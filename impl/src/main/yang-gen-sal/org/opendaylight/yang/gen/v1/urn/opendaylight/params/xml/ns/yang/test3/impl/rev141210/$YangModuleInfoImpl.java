...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "test3-impl";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:test3:impl";
    private final String revision = "2014-12-10";
    private final String resourcePath = "/META-INF/yang/test3-impl.yang";
